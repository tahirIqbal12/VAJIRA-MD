...
global.owner = process.env.OWNER_NUMBER  || '923276519352' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=qAd2lIiS#gV4uHkKjjW07Nx8z3dcRcH6ojT8o3RzaKlpZjD60CR0' ,
